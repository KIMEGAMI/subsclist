...
export const metadata: Metadata = {
  title: "特定商取引法に基づく表記 | サブスクリスト",
  description: "サブスクリストの有料プラン提供に関する販売条件、支払方法、解約方法等を表示します。",
};
...
const rows = [
  ...
  ["支払時期", "Premiumプラン申込時に初回決済が行われ、以後は契約更新日に自動で決済されます。"],
  ["サービス提供時期", "決済完了後、システム上でPremiumプランが有効化された時点から利用できます。"],
  ["返品・キャンセル", "デジタルサービスの性質上、決済完了後の返金は原則としてお受けしていません。ただし、当サービス側の重大な不具合等がある場合は個別に確認します。"],
  ["解約方法", "ログイン後の設定画面、またはStripeのカスタマーポータルから解約できます。解約後は次回更新日以降の請求が停止されます。"],
  ["動作環境", "最新版の主要ブラウザ（Chrome、Edge、Safari、Firefox）での利用を推奨します。"],
  ["表現および商品に関する注意書き", "本サービスはサブスクリプションや固定費の管理を支援するツールです。削減額、解約可否、通知の到達、各サービス提供会社の契約条件を保証するものではありません。"],
] as const;
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-4 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600">
            サブスクリストの有料プラン提供に関する表示です。内容はサービス運営状況や法令改正に応じて更新される場合があります。
          </p>
          ...
          <p className="mt-6 text-xs leading-6 text-slate-500">
            所在地および電話番号について開示請求がある場合は、上記メールアドレス宛にご連絡ください。
            請求者の本人確認および取引内容の確認後、法令に基づき遅滞なく提供します。
          </p>
        </section>
      </div>
    </main>
